...
export namespace movies_v1 {
    ...
    export class GetMoviesByFilterItem extends pb_1.Message {
        ...
        get typeMovie() {
            return pb_1.Message.getFieldWithDefault(this, 1, TypeMovie.ALL) as TypeMovie;
        }
        set typeMovie(value: TypeMovie) {
            pb_1.Message.setField(this, 1, value);
        }
        get search() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.typeMovie != TypeMovie.ALL)
                writer.writeEnum(1, this.typeMovie);
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMoviesByFilterItem {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        message.typeMovie = reader.readEnum();
                        break;
                    case 2:
    ...
    export class GetMovieItem extends pb_1.Message {
        ...
        get genres() {
            return pb_1.Message.getRepeatedWrapperField(this, Genres, 9) as Genres[];
        }
        set genres(value: Genres[]) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.genres.length)
                writer.writeRepeatedMessage(9, this.genres, (item: Genres) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        reader.readMessage(message.genres, () => pb_1.Message.addToRepeatedWrapperField(message, 9, Genres.deserialize(reader), Genres));
                        break;
                    default: reader.skipField();
                }
            }
