...
type MoviesV1Client interface {
	...
	GetMoviesById(ctx context.Context, in *GetMoviesByIdRequest, opts ...grpc.CallOption) (*GetMoviesByIdResponse, error)
	GetMoviesByCategory(ctx context.Context, in *GetMoviesByFilterRequest, opts ...grpc.CallOption) (*GetMoviesResponse, error)
	AddMovies(ctx context.Context, in *AddMoviesRequest, opts ...grpc.CallOption) (*AddMoviesResponse, error)
	DelMovies(ctx context.Context, in *DelMoviesRequest, opts ...grpc.CallOption) (*DelMoviesResponse, error)
}
...
func (c *moviesV1Client) GetMoviesById(ctx context.Context, in *GetMoviesByIdRequest, opts ...grpc.CallOption) (*GetMoviesByIdResponse, error) {
	out := new(GetMoviesByIdResponse)
	err := c.cc.Invoke(ctx, "/movies_v1.MoviesV1/GetMoviesById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *moviesV1Client) GetMoviesByCategory(ctx context.Context, in *GetMoviesByFilterRequest, opts ...grpc.CallOption) (*GetMoviesResponse, error) {
	out := new(GetMoviesResponse)
	err := c.cc.Invoke(ctx, "/movies_v1.MoviesV1/GetMoviesByCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *moviesV1Client) DelMovies(ctx context.Context, in *DelMoviesRequest, opts ...grpc.CallOption) (*DelMoviesResponse, error) {
	out := new(DelMoviesResponse)
	err := c.cc.Invoke(ctx, "/movies_v1.MoviesV1/DelMovies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MoviesV1Server interface {
	...
	GetMoviesById(context.Context, *GetMoviesByIdRequest) (*GetMoviesByIdResponse, error)
	GetMoviesByCategory(context.Context, *GetMoviesByFilterRequest) (*GetMoviesResponse, error)
	AddMovies(context.Context, *AddMoviesRequest) (*AddMoviesResponse, error)
	DelMovies(context.Context, *DelMoviesRequest) (*DelMoviesResponse, error)
...
func (UnimplementedMoviesV1Server) GetMoviesById(context.Context, *GetMoviesByIdRequest) (*GetMoviesByIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMoviesById not implemented")
}
func (UnimplementedMoviesV1Server) GetMoviesByCategory(context.Context, *GetMoviesByFilterRequest) (*GetMoviesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMoviesByCategory not implemented")
}
...
func (UnimplementedMoviesV1Server) DelMovies(context.Context, *DelMoviesRequest) (*DelMoviesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DelMovies not implemented")
}
...
func _MoviesV1_GetMoviesById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMoviesByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MoviesV1Server).GetMoviesById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/movies_v1.MoviesV1/GetMoviesById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MoviesV1Server).GetMoviesById(ctx, req.(*GetMoviesByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MoviesV1_GetMoviesByCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMoviesByFilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MoviesV1Server).GetMoviesByCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/movies_v1.MoviesV1/GetMoviesByCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MoviesV1Server).GetMoviesByCategory(ctx, req.(*GetMoviesByFilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MoviesV1_DelMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DelMoviesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MoviesV1Server).DelMovies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/movies_v1.MoviesV1/DelMovies",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MoviesV1Server).DelMovies(ctx, req.(*DelMoviesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MoviesV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MoviesV1_GetMoviesById_Handler,
		},
		{
			MethodName: "GetMoviesByCategory",
			Handler:    _MoviesV1_GetMoviesByCategory_Handler,
		},
		{
		...
		{
			MethodName: "DelMovies",
			Handler:    _MoviesV1_DelMovies_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/movies_v1/service.proto",
}
